<template>
   ...
   <v-img
    ...
    >
    <v-card-title class="text-h5 mb-1 ">10 over cricket match<br>Baner, Pune</v-card-title>
    </v-img>
    <v-img
      class="white--text align-end"
      height="180px"
    ...
    <v-card-text  class="pb-0 card-subtitle1 text-vcard ">
      A 10-over cricket match played on Sri Vishweswara  ground. All boys aged 15-20 are welcome, make sure to bring your own cricket gear<br>
      <br><span style="font-weight: bold;">Date:</span> 07/04/23&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <span style="font-weight: bold;"> Time:</span> 16:30 <br> 
     <span style="font-weight: bold;">Venue:</span> Sri Vishweshwara Ground,Baner <br> 
    </v-card-text>
      </v-img>
    <v-card-actions>
      <v-btn
